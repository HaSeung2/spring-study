...
@WebMvcTest(controllers = {UserController.class, ProductController.class}, excludeFilters = {@ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = WebSecurityConfig.class)})
class UserProductMvcTest {
    ...
    void test3() throws Exception {
        ...
        // when - then
        mvc.perform(post("/api/products").content(postInfo)
